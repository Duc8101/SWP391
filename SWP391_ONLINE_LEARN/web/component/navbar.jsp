...
<%
    ...
    String d_none1 = role == null || role.equals(Account.ROLE_STUDENT) ? "d-none" : "";
    String d_none2 = role == null || role.equals(Account.ROLE_STUDENT) ? "" : "d-none";
    String d_none3 = role != null && role.equals(Account.ROLE_TEACHER) ? "" : "d-none";
%>
<nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto p-4 p-lg-0">
            ...
            <a href="CreateCourse" class="nav-item nav-link <%=d_none1%>">Create Course</a>
    ...
    <div class="nav-item dropdown">
        ...
        <div class="dropdown-menu fade-down m-0">
            ...
            <a href="MyTeachingCourse" class="dropdown-item <%=d_none3%>">My Teaching Course</a>
