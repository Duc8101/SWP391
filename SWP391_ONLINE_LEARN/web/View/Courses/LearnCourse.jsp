        ...
        <div class="container-fluid" style="height: 715px">
            <div class="row">
                            ...
                            <%
                                for (LessonVideo video : listVideo) {
                                    ...
                                    if (lesson.getLessonID() == video.getLessonID()) {
                                        VideoNumber++;
                            %>       
                            <div class="list-group-item list-group-item- <%= video.getVideoID() == VideoID ? "primary" : "action"%>">
                                <div class="row">
                            ...
                            <%
                                for (LessonPDF PDF : listPDF) {
                                    ...
                                    if (lesson.getLessonID() == PDF.getLessonID()) {
                                        PDFNumber++;
                            %>
                            <div class="list-group-item list-group-item- <%= PDF.getPDFID() == PDFID ? "primary" : "action"%>">
                                <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    %>
                    <div class="mx-5">
                        <embed id="myPDF" src="./resources/PDF/<%=pdf%>" width="98%" height="750px" type="application/pdf" alt="sorry">
                    </div>
                    <%}%>
