...
<html>
    ...
    <body>
        ...
        <br />
        <br />
        <h3 style="margin-left:10%">Your latest submission : <%=result.getScore()%></h3>
        <h3 style="margin-left:10%">Your latest submitted date : <%=result.getDateRecord()%></h3>
        <h3 style="margin-left:10%">Status: <span style="color:<%=result.getStatus().equals(ConstValue.STATUS_NOT_PASS) ? "red" : "green"%>"><%=result.getStatus()%></span></h3>
            <%}%>
        <!-- TAKE Start -->
        <div class="section"> 
