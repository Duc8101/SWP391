                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <select name="gender" class="form-control">
                                                <option value="<%=ConstValue.GENDER_FEMALE%>" <%=teacher.getGender().equalsIgnoreCase(ConstValue.GENDER_FEMALE) ? "selected" : ""%>>Female</option>
                                                <option value="<%=ConstValue.GENDER_MALE%>" <%=teacher.getGender().equalsIgnoreCase(ConstValue.GENDER_MALE) ? "selected" : ""%>>Male</option>
                                                <option value="<%=ConstValue.GENDER_OTHER%>" <%=teacher.getGender().equalsIgnoreCase(ConstValue.GENDER_OTHER) ? "selected" : ""%>>Other</option>
                                            </select>
